     /*Void Loop*/const LoopFunctionStart =
     `\n`
     +
     ...
     `\n \t \t`
     ;
     //Here is where we start selecting pages we want to go to
     ;
...
/*Void Loop*/var LoopFunctionPages = 
        ...
        //Here is where we start adding pages
     for (let i = 0; i<EnumAdjustables.length; i++)
     {
          ...
          `\n \t \t`
          +
          `else if (currentPage == MENU_PAGE && scrollPosition == `
          +
          `${i}`
          +
          `)`
          ...
          `\n \t \t`
          +
          `} // end else if ( MENU_PAGE && scrollPosition == `
          +
          `${i}`
          +
          `)`
